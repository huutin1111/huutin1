<div id="sidebar" class="fl-left">
 ...
 <li class="nav-item">
            ...
            <ul class="sub-menu">
                 <li class="nav-item">
                    <a href="?modules=thongke&controllers=index&action=list" title="" class="nav-link aha">Doanh thu</a>
                </li>
                <li class="nav-item">
                    <a href="?modules=orders&controllers=index&action=list" title="" class="nav-link aha">Danh sách đơn hàng hoàn Thành</a>
                </li>
