                ...
                <div class="section-detail">
                    ...
                    <div class="table-responsive">
                        <a  style=" <?php if(!$data[count($data) - 1]) echo "pointer-events: none;" ?> display: inline-block; text-align: center; margin-bottom: 20px;background-color: green;color: white; border: none; border-radius: 5px; width: 100px;"  href="?modules=orders&controllers=index&action=confirm&id_order=<?php echo $data[count($data)-2]; ?>">Xác nhận <a/>
                            <a  style=" <?php if(!$data[count($data) - 1]) echo "pointer-events: none;" ?> display: inline-block; text-align: center; margin-bottom: 20px;background-color: green;color: white; border: none; border-radius: 5px; width: 100px;"  href="?modules=orders&controllers=index&action=danggiao&id_order=<?php echo $data[count($data)-2]; ?>">Đang giao <a/>
