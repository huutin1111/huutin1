        <div class="sidebar fl-left">
            <div class="section" id="category-product-wp">
                ...
                <div class="secion-detail">
                    <ul class="list-item">
                        <li>
                            <a href="?modules=products&controllers=index&action=show&id_cat=13" title="">Nón nữa đầu</a>
                            <!-- <ul class="sub-menu">
                                <li>
                        ...
                        <li>
                            <a href="?modules=products&controllers=index&action=show&id_cat=14" title="">Nón 3/4</a>
                            <!-- <ul class="sub-menu">
                                <li>
                                    <a href="?page=category_product" title="">Iphone</a>
                                </li>
                        ...
                        <li>
                            <a href="?modules=products&controllers=index&action=show&id_cat=12" title="">Nón trùm kính đầu</a>
                            <!-- <ul class="sub-menu">
                                <li>
                                    <a href="?page=category_product" title="">Iphone</a>
                                </li>
                        ...
                        <li>
                            <a href="?modules=home" title="">Nón Modular</a>
                        </li>
                        <li>
                            <a href="?modules=home" title="">Nón cào cào</a>
                        </li>
                        <li>
                            <a href="?modules=home" title="">Nón leo núi</a>
                        </li>
                        <li>
                            <a href="?modules=home" title="">Phụ kiện</a>
                        </li>
                    </ul>
                </div>
            </div>
