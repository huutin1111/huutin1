            ...
            <div class="section" id="detail-product-wp">
                <div class="section-detail clearfix">
                    ...
                    <div class="info fl-right">
                        ...
                        <div class="desc">
                            <p>Vỏ :<?php echo $data['1']['screen']; ?></p>
                            <p>Xốp :<?php echo $data['1']['operating_system']; ?></p>
                            <p>Vải lót :<?php echo $data['1']['rear_camera']; ?></p>
                            <p>Đường kính :<?php echo $data['1']['front_camera']; ?></p>
                            <p>chứng chỉ :<?php echo $data['1']['cpu'] ;?></p>
                            <p>màu :<?php echo $data['1']['ram']; ?></p>
                            <p> :<?php echo $data['1']['memory'] ;?></p>     
                        </div>
...
<div class="section" id="same-category-wp">
                <div class="section-head">
                    <h3 class="section-title">Hãy để lại bình luận cho bài viết</h3>
                </div>
...
<div class="fb-comments" data-href="https://localhost/Accommodationreview/chitiet.php?id=<?php echo $id ?>" data-numposts="5" data-width=""></div>
